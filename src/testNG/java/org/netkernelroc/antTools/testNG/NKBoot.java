  ...
  public NKBoot(String installDir) {
    ...
    try {
      ...
      String basedir = System.getProperty(
          "org.netkernelroc.antTools.testNG.modules.basedir", "");
      String modules = System
          .getProperty("org.netkernelroc.antTools.testNG.modules");
      ...
      String moduleConf = System.getProperty("org.netkernelroc.antTools.testNG.moduleConf");
      if (moduleConf != null) {
